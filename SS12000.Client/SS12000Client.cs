...
namespace SS12000.Client
{
    ...
    public class SS12000Client : IDisposable
    {
        ...
        public async Task<JsonElement> GetOrganisationsAsync(Dictionary<string, object> queryParams = null)
        {
        ...
        public async Task<JsonElement> GetDutiesAsync(Dictionary<string, object> queryParams = null)
        {
        ...
        public async Task<JsonElement> GetGroupsAsync(Dictionary<string, object> queryParams = null)
        {
